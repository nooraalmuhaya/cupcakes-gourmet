...
| D18 | Imagens dos produtos | Ilustrações SVG simples criadas para o projeto em `frontend/assets/images/produtos/`. `imagem_url` guarda o caminho relativo. | Seção 3.3: sem upload; o admin informa o caminho. |
